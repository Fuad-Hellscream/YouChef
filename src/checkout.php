				...
				<div class="container">
					<div class="row slider-text justify-content-center align-items-center">
						...
						<div class="col-md-7 col-sm-12 text-center ftco-animate">
							<h1 class="mb-3 mt-5 bread"><br><br><br>CHECKOUT</h1>
...
<!-- ###########################################  check out area #################################### -->
<section id="home-getstarted" class="text-center text-light" style="background: url(image/bg_4.jpg)no-repeat fixed;">
    ...
    <div class="container checkout">
      <form action="/action_page.php">
        ...
        <div class="row">
          ...
          <div class="col-50">
              <br><br>
            <h6>BILLING INFORMATION</h6><br><br>
            <label for="fnum"><i class="fa fa-phone"></i> Contact Number</label><br>
            <input name="someid" type="number" onkeypress="return isNumberKey(event)" id="fnum" name="number" placeholder="" >

            <label for="adr"><i class="fa fa-address-card-o"></i>Delivery Address</label>
            <input type="text" id="adr" name="address" placeholder="542 W. 15th Street">
            <label for="city"><i class="fa fa-institution"></i> City</label>
            <input type="text" id="city" name="city" placeholder="Dhaka" disabled>
            <label for="date"><i class="fa fa-datepicker"></i>Delivery Date</label><br>
            <input type="date" id="date" name="date" placeholder="Enter delivery date">

            <!-- <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</p>
            <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</p>
            <p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</p> -->

            <div class="d-block my-3" style="float: left;">
                <div class="custom-control custom-radio">
                  ...
                  <div class="custom-control custom-radio">
                    ...
                    <label class="custom-control-label" for="visa">
                        <i class="fa fa-cc-visa" style="color:navy;"></i> Visa card
                    </label>
                  </div>
                  <div class="custom-control custom-radio">
          ...
          <div class="col-50">
            ...
            <input type="text" id="cname" name="cardname" placeholder="Raihan Chowdhury">
        ...
        <input type="submit" value="Confirm to checkout" class="btn btn-warning btn-sm">
      </form>
    </div>
  </div>
