				...
				<div class="container">
					<div class="row slider-text justify-content-center align-items-center">
						...
						<div class="col-md-7 col-sm-12 text-center ftco-animate">
							<h1 class="mb-3 mt-5 bread"><br><br><br>Ingredient</h1>
							<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home</a></span><span>/Ingredient</span></p>
						</div>
			...
			<div class="container">
				<div class="row justify-content-center mb-5 pb-3 mt-5 pt-5">
					<div class="col-md-7 heading-section text-center ftco-animate">
						<h2 class="mb-4">Special Offer Ingredients</h2>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="pricing-entry d-flex ftco-animate">
							...
							<div class="desc pl-3">
								<div class="d-flex text align-items-center">
									<h3><span>Italian Pizza (20% discount)</span></h3>
									<span class="price">Tk20.00</span>
								</div>
								<div class="d-block">
						...
						<div class="pricing-entry d-flex ftco-animate">
							<div class="img" style="background-image: url(image/pizza-2.jpg);"></div>
							<div class="desc pl-3">
								<div class="d-flex text align-items-center">
									<h3><span>Hawaiian Pizza</span></h3>
									<span class="price">Tk29.00</span>
								</div>
								<div class="d-block">
									<p>A small river named Duden flows by their place and supplies</p>
								</div>
						...
						<div class="pricing-entry d-flex ftco-animate">
							<div class="img" style="background-image: url(image/pizza-3.jpg);"></div>
							<div class="desc pl-3">
								<div class="d-flex text align-items-center">
						...
						<div class="pricing-entry d-flex ftco-animate">
							<div class="img" style="background-image: url(image/pizza-4.jpg);"></div>
							<div class="desc pl-3">
								<div class="d-flex text align-items-center">
					...
					<div class="col-md-6">
						<div class="pricing-entry d-flex ftco-animate">
							<div class="img" style="background-image: url(image/pizza-5.jpg);"></div>
							<div class="desc pl-3">
								<div class="d-flex text align-items-center">
									<h3><span>Hawaiian Special</span></h3>
									<span class="price">Tk49.91</span>
								</div>
								<div class="d-block">
									<p>A small river named Duden flows by their place and supplies</p>
								</div>
						...
						<div class="pricing-entry d-flex ftco-animate">
							<div class="img" style="background-image: url(image/pizza-6.jpg);"></div>
							<div class="desc pl-3">
								<div class="d-flex text align-items-center">
						...
						<div class="pricing-entry d-flex ftco-animate">
							<div class="img" style="background-image: url(image/pizza-7.jpg);"></div>
							<div class="desc pl-3">
								<div class="d-flex text align-items-center">
						...
						<div class="pricing-entry d-flex ftco-animate">
							<div class="img" style="background-image: url(image/pizza-8.jpg);"></div>
							<div class="desc pl-3">
								<div class="d-flex text align-items-center">
...
<!-- add testimonial ################  Our Ready Meals   ##################################### -->
			<div class="container">
				<div class="row justify-content-center mb-5 pb-3">
					<div class="col-md-7 heading-section ftco-animate text-center">
						<h2 class="mb-4">Choose Your Ingredients</h2>
            ...
            <nav class="navbar navbar-expand-lg " style="background: url(image/bg_4.jpg)no-repeat fixed;"  >
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    ...
                    <ul class="nav navbar-nav menu_nav ml-auto" >
                        <!-- <select class="mdb-select md-form mr-1 mt-1 mb-1" searchable="Search here..">
                             <option value="" disabled selected>Filter your food</option>
...
<!-- ###################################################   categories food ################################################## -->
		...
		<div class="container-fluid">
            <div class="row justify-content-center mb-5 pb-3 mt-5 pt-5">
                <div class="col-md-7 heading-section text-center ftco-animate">
                    <h2 class="mb-4">Top Category Ingredients</h2>
                    <p class="flip"><span class="deg1"></span><span class="deg2"></span><span class="deg3"></span></p>
                    <p class="mt-5">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                </div>
            </div>
				...
				<div class="row d-md-flex">
					<div class="col-lg-4 ftco-animate img f-menu-img mb-5 mb-md-0" style="background-image: url(image/about.jpg);">
					</div>
